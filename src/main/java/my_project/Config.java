...
public class Config {
    ...
    public final static int WINDOW_WIDTH = 600+16;
    public final static int WINDOW_HEIGHT = 600+39;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
